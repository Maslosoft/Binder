...
<p class="alert alert-success">
	This documentation will use <code>balin.model</code> object to store all observable model instances.<br />
	Each property in this object is instance of observable model.
</p>
<h4>Intuitive data binding</h4>
<p>
	Balin packages comes with <a href="https://github.com/Maslosoft/knockout-es5" target="_blank">Knockout JS <abbr title="EcmaScript 5" rel="tooltip">ES5</abbr> enchanced plugin</a>.
...
<?= escapeKo('<div data-bind="text: balin.model.nested.rawI18N.name.en"></div>')?>
</pre>
<p>Result of this code is below. Try to change input value:</p>
<div class="well">
<!-- /trim -->
<input data-bind="textInput: balin.model.nested.rawI18N.name.en"></input>
<div data-bind="text: balin.model.nested.rawI18N.name.en"></div>
<!-- trim -->
</div>
<h4>Creating Model</h4>
<p>
	View model in balin package is instance of class. So that it can be reused or extended at will.
</p>
<p>
	To use EcmaScript 5 observable properties, model must extend from <code>Maslosoft.Ko.Balin.Model</code>
...
<p>
	To create new model, extend from <code>Maslosoft.Ko.Balin.Model</code> and add properties - of which
	all will be observable:
</p>
<pre class="coffeescript">
class @Maslosoft.Models.MyChecklist extends @Maslosoft.Ko.Balin.Model
