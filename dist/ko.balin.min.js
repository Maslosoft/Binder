...
null==b&&(b=null),c=k.get(this);for(d in this)e=this[d],l(this[d])&&(this[d]={}),Array.isArray(this[d])&&(this[d]=[]);if(!c){k.set(this,!0);for(d in this)e=this[d],this[d]=ko.tracker.factory(e),l(this[d])&&(this[d]=new Proxy(this[d],new a(this,d)))}for(d in b)e=b[d],this[d]=ko.tracker.factory(e);for(d in this)e=this[d],l(this[d])&&(this[d]=new Proxy(this[d],new a(this,d)));ko.track(this,{deep:!0})}return b}(),this.Maslosoft.Ko.Balin.registerDefaults(),ko.punches.enableAll()}).call(this);